...
public class LocalReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (intent != null) {
            if (intent.getAction().equals("com.snow.user.info.update.action")) {
                createNotificaition(context, intent);
                return;
            }
            if (intent.getAction().equals("com.snow.notification.open.action")) {
    ...
    private void createNotificaition(Context context, Intent intent) {
        ...
        intent.setAction("com.snow.notification.open.action");
