...
import com.steven.base.util.RecyclerView.OnDragVHListener;
import com.steven.base.util.RecyclerView.OnItemMoveListener;

import java.util.List;

/**
 * @user steven
 * @createDate 2019/4/3 10:17
 * @description 自定义
 */
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    private List<DreamTypeEntity> mMyChannelItems, mOtherChannelItems;

    // 我的频道点击事件
    private OnMyChannelItemClickListener mChannelItemClickListener;

    public ChannelAdapter(Context context, ItemTouchHelper helper, List<DreamTypeEntity> mMyChannelItems, List<DreamTypeEntity> mOtherChannelItems) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case TYPE_MY:
                ...
                myHolder.rl_my.setOnClickListener(new View.OnClickListener() {
                    @Override
    ...
    public int getItemCount() {
        // 我的频道标题 + 我的频道.size + 其他频道标题 + 其他频道.size
    ...
    private void moveMyToOther(MyViewHolder myHolder) {
        ...
        DreamTypeEntity item = mMyChannelItems.get(startPosition);
    ...
    private int processItemRemoveAdd(OtherViewHolder otherHolder) {
        ...
        DreamTypeEntity item = mOtherChannelItems.get(startPosition);
    ...
    public void onItemMove(int fromPosition, int toPosition) {
        DreamTypeEntity item = mMyChannelItems.get(fromPosition - COUNT_PRE_MY_HEADER);
    ...
    public void setmChannelItemClickListener(OnMyChannelItemClickListener mChannelItemClickListener) {
        this.mChannelItemClickListener = mChannelItemClickListener;
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements OnDragVHListener {
        ...
        public MyViewHolder(View itemView) {
            ...
            rl_my = (RelativeLayout)itemView.findViewById(R.id.rl_my);
        }
     ...
     * @return
     */
    public List<DreamTypeEntity> getmMyChannelItems() {
     ...
     * @return
     */
    public List<DreamTypeEntity> getmOtherChannelItems() {
