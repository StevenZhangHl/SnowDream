...
/**
 * @user steven
 * @createDate 2019/3/7 17:08
 * @description 自定义
 */
public abstract class BaseNoContainerFrament <T extends BasePresenter, E extends BaseModel> extends SupportFragment implements BaseView, Callback.OnReloadListener {
