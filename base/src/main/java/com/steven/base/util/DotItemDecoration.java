...
public class DotItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void drawVerticalItem(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (mConfig.mStyle == STYLE_RESOURCE) {
                ...
                drawableRight = parentWidth / 2 + mDrawable.getIntrinsicWidth() / 2;
    ...
    public void drawHorizontalItem(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (mConfig.mStyle == STYLE_RESOURCE) {
                ...
                drawableRight = parentHeight / 2 + mDrawable.getIntrinsicWidth() / 2;
    ...
    public static class Builder {
        ...
        public Builder setTopDistance(float distance) {
            mConfig.mTopDistance = DisplayUtil.dip2px(mContext, distance);
            return this;
        }

        public Builder setItemPaddingLeft(float itemPaddingLeft) {
            mConfig.mItemPaddingLeft = DisplayUtil.dip2px(mContext, itemPaddingLeft);
            return this;
        }

        public Builder setItemPaddingRight(float itemPaddingRight) {
            mConfig.mItemPaddingRight = DisplayUtil.dip2px(mContext, itemPaddingRight);
            return this;
        }

        public Builder setItemInterVal(float interval) {
            mConfig.mItemInterval = DisplayUtil.dip2px(mContext, interval);
            return this;
        }

        public Builder setLineWidth(float lineWidth) {
            mConfig.mLineWidth = DisplayUtil.dip2px(mContext, lineWidth);
            return this;
        }
        ...
        public Builder setDotPaddingTop(int paddingTop) {
            mConfig.mDotPaddingTop = DisplayUtil.dip2px(mContext, paddingTop);
            return this;
        }
        ...
        public Builder setDotRadius(int dotRadius) {
            mConfig.mDotRadius = DisplayUtil.dip2px(mContext, dotRadius);
            return this;
        }
        ...
        public Builder setTextSize(float textSize) {
            mConfig.mTextSize = DisplayUtil.dip2px(mContext, textSize);
            return this;
        }

        public Builder setDotPaddingText(float dotPaddingText) {
            mConfig.mDotPaddingText = DisplayUtil.dip2px(mContext, dotPaddingText);
            return this;
        }
        ...
        public Builder setBottomDistance(float bottomDistance) {
            mConfig.mBottomDistance = DisplayUtil.dip2px(mContext, bottomDistance);
            return this;
        }
