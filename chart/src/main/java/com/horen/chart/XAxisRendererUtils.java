 ...
 */
public class XAxisRendererUtils extends XAxisRenderer {

    protected XAxis mXAxis;

    public XAxisRendererUtils(ViewPortHandler viewPortHandler, XAxis xAxis, Transformer trans) {
...
//        mXAxis.mLabelRotatedHeight = Math.round(labelRotatedSize.height);
        // X轴 Label的大小
        mXAxis.mLabelRotatedWidth = DisplayUtil.dip2px(36);
        mXAxis.mLabelRotatedHeight = DisplayUtil.dip2px(36);
        LogUtils.e("mLabelRotatedWidth:" + mXAxis.mLabelRotatedWidth + "---" + "mLabelRotatedHeight:" + mXAxis.mLabelRotatedHeight + "---");
    ...
    public void renderAxisLine(Canvas c) {
        ...
        if (mXAxis.getPosition() == XAxis.XAxisPosition.BOTTOM
            ...
            int i = DisplayUtil.px2dip(startY);
            c.drawLine(mViewPortHandler.contentLeft(),
                    startY, mViewPortHandler.contentRight(),
                    startY, mAxisLinePaint);
        }
    }
