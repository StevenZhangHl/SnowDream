...
public class PieChartHelper {
    ...
    private void setData() {
        ...
        // 指示线颜色
        dataSet.setValueLineColor(lableTextColor);
     ...
     * @param pieData 新数据
     */
    public void setNewData(List<IPieData> pieData) {
    ...
    public static class Builder {
         ...
         * 中心图表孔旁边的透明圆的半径
         */
        private float mTransparentCircleRadiusPercent = 0f;
        /**
         * 动画时间
         */
         ...
         * 饼图Item被选中时变化的距离
         */
        private float selectionShift = 5f;
        /**
         * 颜色集合
         */
        private List<Integer> mPieColors;
        ...
        public PieChartHelper build() {
            ...
            return new PieChartHelper(this);
        }
    }
}
